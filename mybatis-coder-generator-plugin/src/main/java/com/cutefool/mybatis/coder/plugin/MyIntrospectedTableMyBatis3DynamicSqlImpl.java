...
public class MyIntrospectedTableMyBatis3DynamicSqlImpl extends IntrospectedTableMyBatis3Impl {

    public MyIntrospectedTableMyBatis3DynamicSqlImpl() {
    ...
    protected AbstractJavaClientGenerator createJavaClientGenerator() {
        ...
        return new MyDynamicSqlMapperGenerator(getClientProject());
    }
